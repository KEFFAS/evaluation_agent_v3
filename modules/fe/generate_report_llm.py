...
for (facilitator, session), group in grouped:
    ...
    # ===== DESCRIPTION =====
    doc.add_paragraph(
        "This report provides information to KSG management for decision making and action. The Facilitator Evaluation forms are filled by participants in the course of training programs. The Head of Department - Training is expected to discuss the evaluations with individual lecturers where necessary."
    )
